...
export default {
  ...
  methods: {
    fetchSupervisors() {
      this.$axios
        .get("/internal/admin/all-supervisors", {
    ...
    fetchConsultantsBySupervisor() {
      ...
      // 获取当前选择督导的咨询师
      this.$axios
        .get("/internal/admin/all-consultants", {
          headers: { token: this.token },
    ...
    openScheduleDialog(slot) {
      ...
      // 获取已排班的咨询师
      this.$axios
        .get("/internal/admin/schedule/consultant", {
          headers: { token: this.token },
          params: {
            day: slot.day,
            time: slot.time,
    ...
    removeSchedule(sup) {
      this.$axios
        .delete("/internal/admin/schedule/consultant", {
          headers: { token: this.token },
          data: {
    ...
    submitSchedule() {
      ...
      this.$axios
        .post(
          "/internal/admin/schedule/consultant",
