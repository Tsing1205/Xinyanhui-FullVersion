...
@Component
public class ObserveWebsocketConfig extends ServerEndpointConfig.Configurator {
    @Override
    ...
    public void modifyHandshake(ServerEndpointConfig sec,
        ...
        if (parameterMap.containsKey("sessionId")) {
            String token = parameterMap.get("sessionId").get(0);
            sec.getUserProperties().put("sessionId", token);
        }
    }
}
